...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-dark border border-danger img-fluid">
    ...
    <div class="tex-center d-flex justify-content-around">
        ...
        <button type="button" class="btn btn-dark m-2 fs-3"><a href="../usuario/voz.php" class="badge badge-dark">Buscar con voz</a></button>
    </div>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
             ...
             <?php
               $sql="SELECT * FROM productos WHERE Producto = '$product' AND Stock > 0";
