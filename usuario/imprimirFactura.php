...
<head>
    ...
    <title>Imprimir Factura | Declean Glamoure</title>
</head>
<body>
...
<nav class="navbar navbar-expand-lg navbar-light bg-light bg-dark border border-danger img-fluid">
    ...
    <button type="button" class="btn btn-dark m-2"><a href="../ventasUsuario.php" class="badge badge-dark">Regresar</a></button>
    <div class="container-fluid mt-2 w-75">
    
        <h2 class='text-center'>Imprimir Factura</h2>
    </div>

    <!-- Formulario para venta -->
    <div class="container-fluid mt-5 w-25">
             
        <form method="POST" id="formCancelar" action="../includes/factura.php" target="_blank">
            <div class="mb-3">
                <label for="exampleInputEmail1" class="form-label">Codigo de factura</label>
            ...
            <div class="d-flex justify-content-center">
                <button  type="submit" id="imprimir" name="imprimir" class="btn btn-primary">Imprimir factura</button>
            </div>
...
<footer class="texto bg-dark text-light p-3 mt-5 d-flex justify-content-between">
        ...
        <p>Empleado conectado: <span> <?php echo $_SESSION["nombre"]; ?> </span> </p>
         ...
         <script src="../js/script-factura.js"></script>
